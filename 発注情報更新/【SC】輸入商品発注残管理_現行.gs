...
function GetActiveCd() {
  ...
  var wk3 = ss.getSheetByName('work3');
...
function dataUpdate() {
  ...
  var sheet_From = ss_From.getSheetByName('work2');
  ...
  var sheet4 = ss_From.getSheetByName('【GFT】入荷チェックリスト');
  var wk3 = ss_From.getSheetByName('work3');
...
function screenUpdating() {
  ...
  var sheet4 = ss.getSheetByName('【GFT】入荷チェックリスト');
  var wk3 = ss.getSheetByName('work3');
  ...
  //チェックリスト値セット
  var vndCd = sheet1.getRange('B2').getValue();
